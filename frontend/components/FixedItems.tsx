                                            ...
                                            <div className="flex items-center gap-6">
                                                ...
                                                <div className="flex gap-2">
                                                    ...
                                                    <button
                                                        ...
                                                        className="px-3 py-1.5 text-xs font-semibold text-rose-600 dark:text-rose-400 bg-rose-50 dark:bg-rose-500/10 hover:bg-rose-100 dark:hover:bg-rose-500/20 rounded-lg transition-colors border border-rose-200 dark:border-rose-500/20"
                                                    >
                                                        🗑️ Excluir
                                                    </button>
                                                </div>
