...
const translations: Record<AppLanguage, Record<string, string>> = {
  'pt-BR': {
    ...
    'settings.biometric': 'Proteção do App',
    'settings.biometric.helper': 'Exige biometria ou bloqueio do dispositivo ao reabrir o app.',
    'settings.biometric.enablePrompt': 'Ativar proteção do Finanza AI',
    'settings.biometric.unlockTitle': 'Finanza protegido',
    'settings.biometric.unlockSubtitle': 'Use sua biometria ou bloqueio do dispositivo para continuar.',
    'settings.biometric.unlockButton': 'Desbloquear',
    'settings.biometric.enabled': 'Proteção do app ativada.',
    'settings.biometric.disabled': 'Proteção do app desativada.',
    'settings.biometric.unavailable': 'Nenhuma biometria ou bloqueio do dispositivo foi configurado neste celular.',
    'settings.biometric.error': 'Não foi possível atualizar a proteção do app.',
  ...
  en: {
    ...
    'settings.biometric': 'App Protection',
    'settings.biometric.helper': 'Requires biometrics or device lock when reopening the app.',
    'settings.biometric.enablePrompt': 'Enable Finanza AI protection',
    'settings.biometric.unlockTitle': 'Finanza protected',
    'settings.biometric.unlockSubtitle': 'Use biometrics or your device lock to continue.',
    'settings.biometric.unlockButton': 'Unlock',
    'settings.biometric.enabled': 'App protection enabled.',
    'settings.biometric.disabled': 'App protection disabled.',
    'settings.biometric.unavailable': 'No biometrics or device lock is configured on this phone.',
    'settings.biometric.error': 'Could not update app protection.',
