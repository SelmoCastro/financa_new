...
CREATE TABLE "ImportedFitId" (
    ...
    CONSTRAINT "ImportedFitId_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "ImportedFitId_userId_idx" ON "ImportedFitId"("userId");

-- CreateIndex
CREATE UNIQUE INDEX "ImportedFitId_userId_fitId_key" ON "ImportedFitId"("userId", "fitId");
...
-- AddForeignKey
ALTER TABLE "ImportedFitId" ADD CONSTRAINT "ImportedFitId_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
