/**
 * Controller HTTP do domínio de lançamentos recorrentes; recebe as requisições, aplica guards/decorators e delega a regra de negócio aos services.
 */
import {
  Controller,
  Get,
...
export class RecurringTransactionsController {
  ...
  @Get('weight')
  getWeight(@Request() req: RequestWithUser) {
